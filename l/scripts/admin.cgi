...
#
# admin.cgi
#  http://stmgrts.org.uk/l/scripts/admin.cgi?a=list
...
my $date      = `date +'%Y-%m-%d'`;
chop($date);
my $thisScript = "/l/scripts/admin.cgi";
my $msg; 
my $now = "now()";
...
sub password {
	...
	<p><button type="submit" name="action" value="password"  class="button positive"> <img src="/l/images/icons/tick.png" alt=""/> Sumbit </button></p>
...
sub link_edit {
    ...
    while ( $sth->fetch ) {
		...
		<form method="post" action="$thisScript">
				...
				<p><button type="submit" name="a" value="link_save"  class="button positive"> <img src="/l/images/icons/tick.png" alt=""/> Save </button></p>
...
$_[0]
  ...
  http://stmgrts.org.uk/l/$_[1]
			...
			<p><button type="submit" name="a" value="tweet" class="button positive"> <img src="/l/images/icons/tick.png" alt=""/> tweet </button></p>
...
<div class="span-37">
	<fieldset>
       	<legend>Create new link</legend>
			...
			<p><button type="submit" name="a" value="save" class="button positive"> <img src="/l/images/icons/tick.png" alt=""/> Save </button></p>
...
<head>
	...
	<link rel="stylesheet" href="http://www.mahnke.net/css/blueprint/blueprint/plugins/buttons.css" type="text/css" media="screen, projection">
...
$_[0]
	...
	<div id="footer" class="span-24 last">
		...
		<p id="copyright" class="span-6 append-1 last">Copyright &copy; St Margarets Community Website 2010</p>
...
sub stats_past {
	...
	<p><button type="submit" name="a" value="stats"  class="button positive"> <img src=/l/images/icons/tick.png" alt=""/> Get stats! </button></p>
	</form>
<hr>
