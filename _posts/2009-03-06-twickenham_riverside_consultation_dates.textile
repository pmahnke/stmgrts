...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2009-03-06-twickenham_riverside_consultation_dates in site.data.2009-03-06-twickenham_riverside_consultation_dates %}
       <li>

         {{ 2009-03-06-twickenham_riverside_consultation_dates.comment }}

         <cite>{{ 2009-03-06-twickenham_riverside_consultation_dates.author }} on {{ 2009-03-06-twickenham_riverside_consultation_dates.date }}</cite>
