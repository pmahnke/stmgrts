...
<img src="http://stmgrts.org.uk/images/events/mark_good_wine_thumb.jpg" width="150" height="112" alt="Mark of The Good Wine Shop" class="photo right" />
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-04-05-event_reminder_the_good_wine_shop_spring_tasting in site.data.2007-04-05-event_reminder_the_good_wine_shop_spring_tasting %}
       <li>

         {{ 2007-04-05-event_reminder_the_good_wine_shop_spring_tasting.comment }}

         <cite>{{ 2007-04-05-event_reminder_the_good_wine_shop_spring_tasting.author }} on {{ 2007-04-05-event_reminder_the_good_wine_shop_spring_tasting.date }}</cite>
