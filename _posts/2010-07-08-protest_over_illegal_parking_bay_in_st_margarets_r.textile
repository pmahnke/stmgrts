...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2010-07-08-protest_over_illegal_parking_bay_in_st_margarets_r in site.data.2010-07-08-protest_over_illegal_parking_bay_in_st_margarets_r %}
       <li>

         {{ 2010-07-08-protest_over_illegal_parking_bay_in_st_margarets_r.comment }}

         <cite>{{ 2010-07-08-protest_over_illegal_parking_bay_in_st_margarets_r.author }} on {{ 2010-07-08-protest_over_illegal_parking_bay_in_st_margarets_r.date }}</cite>
