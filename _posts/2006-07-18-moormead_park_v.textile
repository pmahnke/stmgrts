...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-07-18-moormead_park_v in site.data.2006-07-18-moormead_park_v %}
       <li>

         {{ 2006-07-18-moormead_park_v.comment }}

         <cite>{{ 2006-07-18-moormead_park_v.author }} on {{ 2006-07-18-moormead_park_v.date }}</cite>
