...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2010-11-25-a_busker_film in site.data.2010-11-25-a_busker_film %}
       <li>

         {{ 2010-11-25-a_busker_film.comment }}

         <cite>{{ 2010-11-25-a_busker_film.author }} on {{ 2010-11-25-a_busker_film.date }}</cite>
