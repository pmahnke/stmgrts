...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2009-07-13-schools_bulging_across_richmond_borough in site.data.2009-07-13-schools_bulging_across_richmond_borough %}
       <li>

         {{ 2009-07-13-schools_bulging_across_richmond_borough.comment }}

         <cite>{{ 2009-07-13-schools_bulging_across_richmond_borough.author }} on {{ 2009-07-13-schools_bulging_across_richmond_borough.date }}</cite>
