...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2005-10-23-more_half_term in site.data.2005-10-23-more_half_term %}
       <li>

         {{ 2005-10-23-more_half_term.comment }}

         <cite>{{ 2005-10-23-more_half_term.author }} on {{ 2005-10-23-more_half_term.date }}</cite>
