...
excerpt: |
    <img src="http://www.stmgrts.org.uk/images/directory/200510200949_Moormead_Park_Group.jpg" alt="Moormead_Park_Group" width="150"  class="photo right" />
...
<img src="/images/directory/200510200949_Moormead_Park_Group.jpg" alt="Moormead_Park_Group" width="250"  class="photo right" />
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2015-10-10-moormead_pavilion_expression_of_interest in site.data.2015-10-10-moormead_pavilion_expression_of_interest %}
       <li>

         {{ 2015-10-10-moormead_pavilion_expression_of_interest.comment }}

         <cite>{{ 2015-10-10-moormead_pavilion_expression_of_interest.author }} on {{ 2015-10-10-moormead_pavilion_expression_of_interest.date }}</cite>
