...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2005-12-07-on_comments in site.data.2005-12-07-on_comments %}
       <li>

         {{ 2005-12-07-on_comments.comment }}

         <cite>{{ 2005-12-07-on_comments.author }} on {{ 2005-12-07-on_comments.date }}</cite>
