...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2005-06-15-a_local_group_c in site.data.2005-06-15-a_local_group_c %}
       <li>

         {{ 2005-06-15-a_local_group_c.comment }}

         <cite>{{ 2005-06-15-a_local_group_c.author }} on {{ 2005-06-15-a_local_group_c.date }}</cite>
