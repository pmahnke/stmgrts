...
excerpt: |
    <a href="http://www.stmgrts.org.uk/images/moormead_park_sketch.gif"><img src="http://www.stmgrts.org.uk/images/moormead_park_sm.gif" width="188" height="141" alt="Moormead Park" class="right ignore" /></a>
...
* upgrading the playground and adding more equipment for older kids ({-L}60k already set aside by the Council for 2006)
...
* level and reseed the pitches ({-L}20k already set aside for this year by he Council)
...
You can also email "parks@richmond.gov.uk":mailto:parks@richmond.gov.uk or call 020 8286 8455 for more information or to offer help.
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2005-10-11-moormead_park_c in site.data.2005-10-11-moormead_park_c %}
       <li>

         {{ 2005-10-11-moormead_park_c.comment }}

         <cite>{{ 2005-10-11-moormead_park_c.author }} on {{ 2005-10-11-moormead_park_c.date }}</cite>
