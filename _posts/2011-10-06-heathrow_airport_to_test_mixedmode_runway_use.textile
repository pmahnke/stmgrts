...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2011-10-06-heathrow_airport_to_test_mixedmode_runway_use in site.data.2011-10-06-heathrow_airport_to_test_mixedmode_runway_use %}
       <li>

         {{ 2011-10-06-heathrow_airport_to_test_mixedmode_runway_use.comment }}

         <cite>{{ 2011-10-06-heathrow_airport_to_test_mixedmode_runway_use.author }} on {{ 2011-10-06-heathrow_airport_to_test_mixedmode_runway_use.date }}</cite>
