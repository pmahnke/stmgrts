...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2014-09-12-gloriana_boathouse_plans_in_marble_hill_dropped in site.data.2014-09-12-gloriana_boathouse_plans_in_marble_hill_dropped %}
       <li>

         {{ 2014-09-12-gloriana_boathouse_plans_in_marble_hill_dropped.comment }}

         <cite>{{ 2014-09-12-gloriana_boathouse_plans_in_marble_hill_dropped.author }} on {{ 2014-09-12-gloriana_boathouse_plans_in_marble_hill_dropped.date }}</cite>
