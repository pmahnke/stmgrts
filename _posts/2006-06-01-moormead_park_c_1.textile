...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-06-01-moormead_park_c_1 in site.data.2006-06-01-moormead_park_c_1 %}
       <li>

         {{ 2006-06-01-moormead_park_c_1.comment }}

         <cite>{{ 2006-06-01-moormead_park_c_1.author }} on {{ 2006-06-01-moormead_park_c_1.date }}</cite>
