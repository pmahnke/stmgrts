...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2009-03-15-st_margarets_south_cpz_extension_review in site.data.2009-03-15-st_margarets_south_cpz_extension_review %}
       <li>

         {{ 2009-03-15-st_margarets_south_cpz_extension_review.comment }}

         <cite>{{ 2009-03-15-st_margarets_south_cpz_extension_review.author }} on {{ 2009-03-15-st_margarets_south_cpz_extension_review.date }}</cite>
