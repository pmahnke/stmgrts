...
<a href="http://www.stmgrts.org.uk/images/comedyoferrors.jpg"><img src="http://www.stmgrts.org.uk/images/comedyoferrors-thumb.jpg" width="150" height="99" alt="Jo Meredith and Raif Watts in Time, the show's opening sequence." class="photo right" /></a>
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-06-29-event_reminder_open_air_bard in site.data.2007-06-29-event_reminder_open_air_bard %}
       <li>

         {{ 2007-06-29-event_reminder_open_air_bard.comment }}

         <cite>{{ 2007-06-29-event_reminder_open_air_bard.author }} on {{ 2007-06-29-event_reminder_open_air_bard.date }}</cite>
