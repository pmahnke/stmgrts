...
<img src="/images/hot/hot_ParVinu-logo.gif" width="100" height="46" alt="Par Vinu Logo" class="photo right" />
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-02-22-wine_bar_gets_p in site.data.2006-02-22-wine_bar_gets_p %}
       <li>

         {{ 2006-02-22-wine_bar_gets_p.comment }}

         <cite>{{ 2006-02-22-wine_bar_gets_p.author }} on {{ 2006-02-22-wine_bar_gets_p.date }}</cite>
