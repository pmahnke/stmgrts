...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-11-13-letter_to_the_e in site.data.2006-11-13-letter_to_the_e %}
       <li>

         {{ 2006-11-13-letter_to_the_e.comment }}

         <cite>{{ 2006-11-13-letter_to_the_e.author }} on {{ 2006-11-13-letter_to_the_e.date }}</cite>
