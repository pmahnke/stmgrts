...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2012-03-28-stars_join_campaign_to_save_film_studio in site.data.2012-03-28-stars_join_campaign_to_save_film_studio %}
       <li>

         {{ 2012-03-28-stars_join_campaign_to_save_film_studio.comment }}

         <cite>{{ 2012-03-28-stars_join_campaign_to_save_film_studio.author }} on {{ 2012-03-28-stars_join_campaign_to_save_film_studio.date }}</cite>
