...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2005-09-07-no_backlit_sign_1 in site.data.2005-09-07-no_backlit_sign_1 %}
       <li>

         {{ 2005-09-07-no_backlit_sign_1.comment }}

         <cite>{{ 2005-09-07-no_backlit_sign_1.author }} on {{ 2005-09-07-no_backlit_sign_1.date }}</cite>
