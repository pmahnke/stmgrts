...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2008-10-25-planning_proposal_for_crown_works in site.data.2008-10-25-planning_proposal_for_crown_works %}
       <li>

         {{ 2008-10-25-planning_proposal_for_crown_works.comment }}

         <cite>{{ 2008-10-25-planning_proposal_for_crown_works.author }} on {{ 2008-10-25-planning_proposal_for_crown_works.date }}</cite>
