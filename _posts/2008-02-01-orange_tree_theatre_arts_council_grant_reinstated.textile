...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2008-02-01-orange_tree_theatre_arts_council_grant_reinstated in site.data.2008-02-01-orange_tree_theatre_arts_council_grant_reinstated %}
       <li>

         {{ 2008-02-01-orange_tree_theatre_arts_council_grant_reinstated.comment }}

         <cite>{{ 2008-02-01-orange_tree_theatre_arts_council_grant_reinstated.author }} on {{ 2008-02-01-orange_tree_theatre_arts_council_grant_reinstated.date }}</cite>
