...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-04-16-notes_st_margar in site.data.2006-04-16-notes_st_margar %}
       <li>

         {{ 2006-04-16-notes_st_margar.comment }}

         <cite>{{ 2006-04-16-notes_st_margar.author }} on {{ 2006-04-16-notes_st_margar.date }}</cite>
