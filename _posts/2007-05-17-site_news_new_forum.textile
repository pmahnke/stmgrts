...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-05-17-site_news_new_forum in site.data.2007-05-17-site_news_new_forum %}
       <li>

         {{ 2007-05-17-site_news_new_forum.comment }}

         <cite>{{ 2007-05-17-site_news_new_forum.author }} on {{ 2007-05-17-site_news_new_forum.date }}</cite>
