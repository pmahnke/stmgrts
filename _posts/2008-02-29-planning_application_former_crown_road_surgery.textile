...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2008-02-29-planning_application_former_crown_road_surgery in site.data.2008-02-29-planning_application_former_crown_road_surgery %}
       <li>

         {{ 2008-02-29-planning_application_former_crown_road_surgery.comment }}

         <cite>{{ 2008-02-29-planning_application_former_crown_road_surgery.author }} on {{ 2008-02-29-planning_application_former_crown_road_surgery.date }}</cite>
