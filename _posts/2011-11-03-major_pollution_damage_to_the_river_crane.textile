...
excerpt: |
    <a href="http://www.flickr.com/photos/mahnke/5739482014/" title="River Crane from Moormead Bridge by Peter M, on Flickr"><img src="http://farm4.static.flickr.com/3195/5739482014_b3f7cd0310_m.jpg" width="150"  alt="River Crane from Moormead Bridge" class="photo right"></a>
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2011-11-03-major_pollution_damage_to_the_river_crane in site.data.2011-11-03-major_pollution_damage_to_the_river_crane %}
       <li>

         {{ 2011-11-03-major_pollution_damage_to_the_river_crane.comment }}

         <cite>{{ 2011-11-03-major_pollution_damage_to_the_river_crane.author }} on {{ 2011-11-03-major_pollution_damage_to_the_river_crane.date }}</cite>
