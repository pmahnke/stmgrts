...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-01-06-double_yellow_l in site.data.2007-01-06-double_yellow_l %}
       <li>

         {{ 2007-01-06-double_yellow_l.comment }}

         <cite>{{ 2007-01-06-double_yellow_l.author }} on {{ 2007-01-06-double_yellow_l.date }}</cite>
