...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-03-26-council_reviews_moormead_charges_to_reach_agreemen in site.data.2007-03-26-council_reviews_moormead_charges_to_reach_agreemen %}
       <li>

         {{ 2007-03-26-council_reviews_moormead_charges_to_reach_agreemen.comment }}

         <cite>{{ 2007-03-26-council_reviews_moormead_charges_to_reach_agreemen.author }} on {{ 2007-03-26-council_reviews_moormead_charges_to_reach_agreemen.date }}</cite>
