...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2015-01-15-tfl_decides_keeps_a316_footbridge in site.data.2015-01-15-tfl_decides_keeps_a316_footbridge %}
       <li>

         {{ 2015-01-15-tfl_decides_keeps_a316_footbridge.comment }}

         <cite>{{ 2015-01-15-tfl_decides_keeps_a316_footbridge.author }} on {{ 2015-01-15-tfl_decides_keeps_a316_footbridge.date }}</cite>
