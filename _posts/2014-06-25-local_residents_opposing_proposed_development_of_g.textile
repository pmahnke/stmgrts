...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2014-06-25-local_residents_opposing_proposed_development_of_g in site.data.2014-06-25-local_residents_opposing_proposed_development_of_g %}
       <li>

         {{ 2014-06-25-local_residents_opposing_proposed_development_of_g.comment }}

         <cite>{{ 2014-06-25-local_residents_opposing_proposed_development_of_g.author }} on {{ 2014-06-25-local_residents_opposing_proposed_development_of_g.date }}</cite>
