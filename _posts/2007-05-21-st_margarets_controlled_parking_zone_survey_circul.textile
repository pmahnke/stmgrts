...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-05-21-st_margarets_controlled_parking_zone_survey_circul in site.data.2007-05-21-st_margarets_controlled_parking_zone_survey_circul %}
       <li>

         {{ 2007-05-21-st_margarets_controlled_parking_zone_survey_circul.comment }}

         <cite>{{ 2007-05-21-st_margarets_controlled_parking_zone_survey_circul.author }} on {{ 2007-05-21-st_margarets_controlled_parking_zone_survey_circul.date }}</cite>
