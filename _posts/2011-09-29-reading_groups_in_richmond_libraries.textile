...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2011-09-29-reading_groups_in_richmond_libraries in site.data.2011-09-29-reading_groups_in_richmond_libraries %}
       <li>

         {{ 2011-09-29-reading_groups_in_richmond_libraries.comment }}

         <cite>{{ 2011-09-29-reading_groups_in_richmond_libraries.author }} on {{ 2011-09-29-reading_groups_in_richmond_libraries.date }}</cite>
