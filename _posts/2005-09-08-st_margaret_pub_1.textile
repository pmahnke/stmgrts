...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2005-09-08-st_margaret_pub_1 in site.data.2005-09-08-st_margaret_pub_1 %}
       <li>

         {{ 2005-09-08-st_margaret_pub_1.comment }}

         <cite>{{ 2005-09-08-st_margaret_pub_1.author }} on {{ 2005-09-08-st_margaret_pub_1.date }}</cite>
