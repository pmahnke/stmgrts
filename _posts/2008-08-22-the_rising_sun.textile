...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2008-08-22-the_rising_sun in site.data.2008-08-22-the_rising_sun %}
       <li>

         {{ 2008-08-22-the_rising_sun.comment }}

         <cite>{{ 2008-08-22-the_rising_sun.author }} on {{ 2008-08-22-the_rising_sun.date }}</cite>
