...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2009-11-28-gas_pipe_replacement_outside_the_turks_head_pub in site.data.2009-11-28-gas_pipe_replacement_outside_the_turks_head_pub %}
       <li>

         {{ 2009-11-28-gas_pipe_replacement_outside_the_turks_head_pub.comment }}

         <cite>{{ 2009-11-28-gas_pipe_replacement_outside_the_turks_head_pub.author }} on {{ 2009-11-28-gas_pipe_replacement_outside_the_turks_head_pub.date }}</cite>
