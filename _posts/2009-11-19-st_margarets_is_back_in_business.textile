...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2009-11-19-st_margarets_is_back_in_business in site.data.2009-11-19-st_margarets_is_back_in_business %}
       <li>

         {{ 2009-11-19-st_margarets_is_back_in_business.comment }}

         <cite>{{ 2009-11-19-st_margarets_is_back_in_business.author }} on {{ 2009-11-19-st_margarets_is_back_in_business.date }}</cite>
