...
<a href="/images/events/mark_good_wine.jpg" title="See larger version of - Mark of The Good Wine Shop"><img src="/images/events/mark_good_wine_thumb.jpg" width="150" height="112" alt="Mark of The Good Wine Shop" class="photo right" /></a>
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-11-08-good_wine_shop_tasting_event in site.data.2007-11-08-good_wine_shop_tasting_event %}
       <li>

         {{ 2007-11-08-good_wine_shop_tasting_event.comment }}

         <cite>{{ 2007-11-08-good_wine_shop_tasting_event.author }} on {{ 2007-11-08-good_wine_shop_tasting_event.date }}</cite>
