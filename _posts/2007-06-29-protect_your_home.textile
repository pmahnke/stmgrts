...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-06-29-protect_your_home in site.data.2007-06-29-protect_your_home %}
       <li>

         {{ 2007-06-29-protect_your_home.comment }}

         <cite>{{ 2007-06-29-protect_your_home.author }} on {{ 2007-06-29-protect_your_home.date }}</cite>
