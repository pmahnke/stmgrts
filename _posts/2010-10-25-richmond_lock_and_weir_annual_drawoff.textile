...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2010-10-25-richmond_lock_and_weir_annual_drawoff in site.data.2010-10-25-richmond_lock_and_weir_annual_drawoff %}
       <li>

         {{ 2010-10-25-richmond_lock_and_weir_annual_drawoff.comment }}

         <cite>{{ 2010-10-25-richmond_lock_and_weir_annual_drawoff.author }} on {{ 2010-10-25-richmond_lock_and_weir_annual_drawoff.date }}</cite>
