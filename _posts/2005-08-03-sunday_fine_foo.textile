...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2005-08-03-sunday_fine_foo in site.data.2005-08-03-sunday_fine_foo %}
       <li>

         {{ 2005-08-03-sunday_fine_foo.comment }}

         <cite>{{ 2005-08-03-sunday_fine_foo.author }} on {{ 2005-08-03-sunday_fine_foo.date }}</cite>
