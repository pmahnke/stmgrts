...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-05-11-potential_fraud in site.data.2006-05-11-potential_fraud %}
       <li>

         {{ 2006-05-11-potential_fraud.comment }}

         <cite>{{ 2006-05-11-potential_fraud.author }} on {{ 2006-05-11-potential_fraud.date }}</cite>
