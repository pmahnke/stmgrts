...
<img alt="ParVinu Logo" src="http://www.stmgrts.org.uk/archives/ParVinu-logo-thumb.gif" width="150" height="69" class="img_right" />
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2005-09-29-interview_princ_1 in site.data.2005-09-29-interview_princ_1 %}
       <li>

         {{ 2005-09-29-interview_princ_1.comment }}

         <cite>{{ 2005-09-29-interview_princ_1.author }} on {{ 2005-09-29-interview_princ_1.date }}</cite>
