...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2012-04-12-missing_tortoise_april_2012 in site.data.2012-04-12-missing_tortoise_april_2012 %}
       <li>

         {{ 2012-04-12-missing_tortoise_april_2012.comment }}

         <cite>{{ 2012-04-12-missing_tortoise_april_2012.author }} on {{ 2012-04-12-missing_tortoise_april_2012.date }}</cite>
