...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-12-06-cpz_update in site.data.2007-12-06-cpz_update %}
       <li>

         {{ 2007-12-06-cpz_update.comment }}

         <cite>{{ 2007-12-06-cpz_update.author }} on {{ 2007-12-06-cpz_update.date }}</cite>
