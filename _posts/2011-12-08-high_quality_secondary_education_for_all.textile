...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2011-12-08-high_quality_secondary_education_for_all in site.data.2011-12-08-high_quality_secondary_education_for_all %}
       <li>

         {{ 2011-12-08-high_quality_secondary_education_for_all.comment }}

         <cite>{{ 2011-12-08-high_quality_secondary_education_for_all.author }} on {{ 2011-12-08-high_quality_secondary_education_for_all.date }}</cite>
