...
_Or, I'm only a resident get me out of here_
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2010-04-15-how_green_is_my_council in site.data.2010-04-15-how_green_is_my_council %}
       <li>

         {{ 2010-04-15-how_green_is_my_council.comment }}

         <cite>{{ 2010-04-15-how_green_is_my_council.author }} on {{ 2010-04-15-how_green_is_my_council.date }}</cite>
