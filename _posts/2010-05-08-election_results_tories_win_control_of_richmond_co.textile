...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2010-05-08-election_results_tories_win_control_of_richmond_co in site.data.2010-05-08-election_results_tories_win_control_of_richmond_co %}
       <li>

         {{ 2010-05-08-election_results_tories_win_control_of_richmond_co.comment }}

         <cite>{{ 2010-05-08-election_results_tories_win_control_of_richmond_co.author }} on {{ 2010-05-08-election_results_tories_win_control_of_richmond_co.date }}</cite>
