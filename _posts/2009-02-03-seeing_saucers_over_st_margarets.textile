...
excerpt: |
    <img alt="flying saucer- not real!" src="http://www.stmgrts.org.uk/images/flyingsaucer-thumb.jpg" width="150" height="115" class="photo right" />
...
bq. "What does all this stuff about flying saucers amount to? What can it mean? What is the truth?"
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2009-02-03-seeing_saucers_over_st_margarets in site.data.2009-02-03-seeing_saucers_over_st_margarets %}
       <li>

         {{ 2009-02-03-seeing_saucers_over_st_margarets.comment }}

         <cite>{{ 2009-02-03-seeing_saucers_over_st_margarets.author }} on {{ 2009-02-03-seeing_saucers_over_st_margarets.date }}</cite>
