...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2008-06-26-chase_buchanan_taking_phillip_hodges_offices in site.data.2008-06-26-chase_buchanan_taking_phillip_hodges_offices %}
       <li>

         {{ 2008-06-26-chase_buchanan_taking_phillip_hodges_offices.comment }}

         <cite>{{ 2008-06-26-chase_buchanan_taking_phillip_hodges_offices.author }} on {{ 2008-06-26-chase_buchanan_taking_phillip_hodges_offices.date }}</cite>
