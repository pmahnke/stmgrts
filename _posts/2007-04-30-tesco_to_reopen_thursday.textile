...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-04-30-tesco_to_reopen_thursday in site.data.2007-04-30-tesco_to_reopen_thursday %}
       <li>

         {{ 2007-04-30-tesco_to_reopen_thursday.comment }}

         <cite>{{ 2007-04-30-tesco_to_reopen_thursday.author }} on {{ 2007-04-30-tesco_to_reopen_thursday.date }}</cite>
