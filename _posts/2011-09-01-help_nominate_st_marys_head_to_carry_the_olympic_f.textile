...
<img src="http://www.lloydstsblondon2012.co.uk/assets/ltsb/img/otr_logo.png" width="72" height="112" alt="Olympic 2012 logo" class="right" />
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2011-09-01-help_nominate_st_marys_head_to_carry_the_olympic_f in site.data.2011-09-01-help_nominate_st_marys_head_to_carry_the_olympic_f %}
       <li>

         {{ 2011-09-01-help_nominate_st_marys_head_to_carry_the_olympic_f.comment }}

         <cite>{{ 2011-09-01-help_nominate_st_marys_head_to_carry_the_olympic_f.author }} on {{ 2011-09-01-help_nominate_st_marys_head_to_carry_the_olympic_f.date }}</cite>
