...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2013-10-04-another_accident_on_the_river_crane in site.data.2013-10-04-another_accident_on_the_river_crane %}
       <li>

         {{ 2013-10-04-another_accident_on_the_river_crane.comment }}

         <cite>{{ 2013-10-04-another_accident_on_the_river_crane.author }} on {{ 2013-10-04-another_accident_on_the_river_crane.date }}</cite>
