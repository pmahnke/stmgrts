...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2014-07-17-thames_water_repollutes_river_just_two_days_after in site.data.2014-07-17-thames_water_repollutes_river_just_two_days_after %}
       <li>

         {{ 2014-07-17-thames_water_repollutes_river_just_two_days_after.comment }}

         <cite>{{ 2014-07-17-thames_water_repollutes_river_just_two_days_after.author }} on {{ 2014-07-17-thames_water_repollutes_river_just_two_days_after.date }}</cite>
