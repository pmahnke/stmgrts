...
excerpt: |
    <a href="http://www.stmgrts.org.uk/images//riverkill.jpg" title="See larger version of - Dead fish"><img src="http://www.stmgrts.org.uk/images//riverkill_thumb.jpg" width="150" height="112" alt="Dead fish" class="photo right" /></a>
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2011-06-09-massive_fish_kill_following_thames_pollution_incid in site.data.2011-06-09-massive_fish_kill_following_thames_pollution_incid %}
       <li>

         {{ 2011-06-09-massive_fish_kill_following_thames_pollution_incid.comment }}

         <cite>{{ 2011-06-09-massive_fish_kill_following_thames_pollution_incid.author }} on {{ 2011-06-09-massive_fish_kill_following_thames_pollution_incid.date }}</cite>
