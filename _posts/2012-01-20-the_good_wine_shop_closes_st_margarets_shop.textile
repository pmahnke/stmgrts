...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2012-01-20-the_good_wine_shop_closes_st_margarets_shop in site.data.2012-01-20-the_good_wine_shop_closes_st_margarets_shop %}
       <li>

         {{ 2012-01-20-the_good_wine_shop_closes_st_margarets_shop.comment }}

         <cite>{{ 2012-01-20-the_good_wine_shop_closes_st_margarets_shop.author }} on {{ 2012-01-20-the_good_wine_shop_closes_st_margarets_shop.date }}</cite>
