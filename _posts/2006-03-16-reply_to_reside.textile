...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-03-16-reply_to_reside in site.data.2006-03-16-reply_to_reside %}
       <li>

         {{ 2006-03-16-reply_to_reside.comment }}

         <cite>{{ 2006-03-16-reply_to_reside.author }} on {{ 2006-03-16-reply_to_reside.date }}</cite>
