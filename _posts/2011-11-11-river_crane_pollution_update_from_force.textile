...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2011-11-11-river_crane_pollution_update_from_force in site.data.2011-11-11-river_crane_pollution_update_from_force %}
       <li>

         {{ 2011-11-11-river_crane_pollution_update_from_force.comment }}

         <cite>{{ 2011-11-11-river_crane_pollution_update_from_force.author }} on {{ 2011-11-11-river_crane_pollution_update_from_force.date }}</cite>
