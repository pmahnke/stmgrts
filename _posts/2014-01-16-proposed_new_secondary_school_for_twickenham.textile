...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2014-01-16-proposed_new_secondary_school_for_twickenham in site.data.2014-01-16-proposed_new_secondary_school_for_twickenham %}
       <li>

         {{ 2014-01-16-proposed_new_secondary_school_for_twickenham.comment }}

         <cite>{{ 2014-01-16-proposed_new_secondary_school_for_twickenham.author }} on {{ 2014-01-16-proposed_new_secondary_school_for_twickenham.date }}</cite>
