...
excerpt: |
    <a href="http://www.stmgrts.org.uk/images/gI_0_santapostbox.jpg"><img alt="Santa's North Pole Postbox - stationed in St Margarets" src="http://www.stmgrts.org.uk/images/gI_0_santapostbox-thumb.jpg" width="150" height="150" class="photo right" /></a>
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2009-11-30-santa_gets_a_helping_hand_from_st_margarets_trader in site.data.2009-11-30-santa_gets_a_helping_hand_from_st_margarets_trader %}
       <li>

         {{ 2009-11-30-santa_gets_a_helping_hand_from_st_margarets_trader.comment }}

         <cite>{{ 2009-11-30-santa_gets_a_helping_hand_from_st_margarets_trader.author }} on {{ 2009-11-30-santa_gets_a_helping_hand_from_st_margarets_trader.date }}</cite>
