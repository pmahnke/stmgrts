...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-10-08-mr_frisby_local in site.data.2006-10-08-mr_frisby_local %}
       <li>

         {{ 2006-10-08-mr_frisby_local.comment }}

         <cite>{{ 2006-10-08-mr_frisby_local.author }} on {{ 2006-10-08-mr_frisby_local.date }}</cite>
