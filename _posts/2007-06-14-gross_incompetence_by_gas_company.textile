...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-06-14-gross_incompetence_by_gas_company in site.data.2007-06-14-gross_incompetence_by_gas_company %}
       <li>

         {{ 2007-06-14-gross_incompetence_by_gas_company.comment }}

         <cite>{{ 2007-06-14-gross_incompetence_by_gas_company.author }} on {{ 2007-06-14-gross_incompetence_by_gas_company.date }}</cite>
