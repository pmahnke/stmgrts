...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-05-20-another_false_f in site.data.2006-05-20-another_false_f %}
       <li>

         {{ 2006-05-20-another_false_f.comment }}

         <cite>{{ 2006-05-20-another_false_f.author }} on {{ 2006-05-20-another_false_f.date }}</cite>
