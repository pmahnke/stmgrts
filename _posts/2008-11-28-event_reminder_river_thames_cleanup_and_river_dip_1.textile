...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2008-11-28-event_reminder_river_thames_cleanup_and_river_dip_1 in site.data.2008-11-28-event_reminder_river_thames_cleanup_and_river_dip_1 %}
       <li>

         {{ 2008-11-28-event_reminder_river_thames_cleanup_and_river_dip_1.comment }}

         <cite>{{ 2008-11-28-event_reminder_river_thames_cleanup_and_river_dip_1.author }} on {{ 2008-11-28-event_reminder_river_thames_cleanup_and_river_dip_1.date }}</cite>
