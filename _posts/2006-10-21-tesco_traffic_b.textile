...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-10-21-tesco_traffic_b in site.data.2006-10-21-tesco_traffic_b %}
       <li>

         {{ 2006-10-21-tesco_traffic_b.comment }}

         <cite>{{ 2006-10-21-tesco_traffic_b.author }} on {{ 2006-10-21-tesco_traffic_b.date }}</cite>
