...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2011-05-05-take_the_polices_public_access_survey in site.data.2011-05-05-take_the_polices_public_access_survey %}
       <li>

         {{ 2011-05-05-take_the_polices_public_access_survey.comment }}

         <cite>{{ 2011-05-05-take_the_polices_public_access_survey.author }} on {{ 2011-05-05-take_the_polices_public_access_survey.date }}</cite>
