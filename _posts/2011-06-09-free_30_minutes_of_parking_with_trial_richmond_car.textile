...
<a href="http://www.mystmargarets.com/richmondcard_image.jpg"><img alt="richmondcard_image.jpg" src="http://www.mystmargarets.com/richmondcard_image-thumb.jpg" width="150" height="96" class="right" /></a>
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2011-06-09-free_30_minutes_of_parking_with_trial_richmond_car in site.data.2011-06-09-free_30_minutes_of_parking_with_trial_richmond_car %}
       <li>

         {{ 2011-06-09-free_30_minutes_of_parking_with_trial_richmond_car.comment }}

         <cite>{{ 2011-06-09-free_30_minutes_of_parking_with_trial_richmond_car.author }} on {{ 2011-06-09-free_30_minutes_of_parking_with_trial_richmond_car.date }}</cite>
