...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2011-06-16-school_starts_four_months_late_for_st_margarets_pu in site.data.2011-06-16-school_starts_four_months_late_for_st_margarets_pu %}
       <li>

         {{ 2011-06-16-school_starts_four_months_late_for_st_margarets_pu.comment }}

         <cite>{{ 2011-06-16-school_starts_four_months_late_for_st_margarets_pu.author }} on {{ 2011-06-16-school_starts_four_months_late_for_st_margarets_pu.date }}</cite>
