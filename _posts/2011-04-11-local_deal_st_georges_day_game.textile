...
excerpt: |
    <a href="http://www.stmgrts.org.uk/images//RFU_st-george.jpg" title="See larger version of - RFU Poster"><img src="http://www.stmgrts.org.uk/images//RFU_st-george_thumb.jpg" width="150" height="211" alt="RFU Poster" class="photo right" /></a>
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2011-04-11-local_deal_st_georges_day_game in site.data.2011-04-11-local_deal_st_georges_day_game %}
       <li>

         {{ 2011-04-11-local_deal_st_georges_day_game.comment }}

         <cite>{{ 2011-04-11-local_deal_st_georges_day_game.author }} on {{ 2011-04-11-local_deal_st_georges_day_game.date }}</cite>
