...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2010-03-12-st_margarets_fair_2009_charity_beneficiaries in site.data.2010-03-12-st_margarets_fair_2009_charity_beneficiaries %}
       <li>

         {{ 2010-03-12-st_margarets_fair_2009_charity_beneficiaries.comment }}

         <cite>{{ 2010-03-12-st_margarets_fair_2009_charity_beneficiaries.author }} on {{ 2010-03-12-st_margarets_fair_2009_charity_beneficiaries.date }}</cite>
