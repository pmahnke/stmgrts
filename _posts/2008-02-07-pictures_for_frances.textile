...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2008-02-07-pictures_for_frances in site.data.2008-02-07-pictures_for_frances %}
       <li>

         {{ 2008-02-07-pictures_for_frances.comment }}

         <cite>{{ 2008-02-07-pictures_for_frances.author }} on {{ 2008-02-07-pictures_for_frances.date }}</cite>
