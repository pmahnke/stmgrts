...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2005-10-20-misquoted_apolo in site.data.2005-10-20-misquoted_apolo %}
       <li>

         {{ 2005-10-20-misquoted_apolo.comment }}

         <cite>{{ 2005-10-20-misquoted_apolo.author }} on {{ 2005-10-20-misquoted_apolo.date }}</cite>
