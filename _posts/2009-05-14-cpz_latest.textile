...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2009-05-14-cpz_latest in site.data.2009-05-14-cpz_latest %}
       <li>

         {{ 2009-05-14-cpz_latest.comment }}

         <cite>{{ 2009-05-14-cpz_latest.author }} on {{ 2009-05-14-cpz_latest.date }}</cite>
