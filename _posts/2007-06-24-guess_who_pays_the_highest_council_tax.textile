...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-06-24-guess_who_pays_the_highest_council_tax in site.data.2007-06-24-guess_who_pays_the_highest_council_tax %}
       <li>

         {{ 2007-06-24-guess_who_pays_the_highest_council_tax.comment }}

         <cite>{{ 2007-06-24-guess_who_pays_the_highest_council_tax.author }} on {{ 2007-06-24-guess_who_pays_the_highest_council_tax.date }}</cite>
