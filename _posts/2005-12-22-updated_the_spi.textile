...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2005-12-22-updated_the_spi in site.data.2005-12-22-updated_the_spi %}
       <li>

         {{ 2005-12-22-updated_the_spi.comment }}

         <cite>{{ 2005-12-22-updated_the_spi.author }} on {{ 2005-12-22-updated_the_spi.date }}</cite>
