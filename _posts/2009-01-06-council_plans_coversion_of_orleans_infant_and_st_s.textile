...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2009-01-06-council_plans_coversion_of_orleans_infant_and_st_s in site.data.2009-01-06-council_plans_coversion_of_orleans_infant_and_st_s %}
       <li>

         {{ 2009-01-06-council_plans_coversion_of_orleans_infant_and_st_s.comment }}

         <cite>{{ 2009-01-06-council_plans_coversion_of_orleans_infant_and_st_s.author }} on {{ 2009-01-06-council_plans_coversion_of_orleans_infant_and_st_s.date }}</cite>
