...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-06-14-moor_mead_and_friends_group in site.data.2007-06-14-moor_mead_and_friends_group %}
       <li>

         {{ 2007-06-14-moor_mead_and_friends_group.comment }}

         <cite>{{ 2007-06-14-moor_mead_and_friends_group.author }} on {{ 2007-06-14-moor_mead_and_friends_group.date }}</cite>
