...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2005-09-30-broadway_object in site.data.2005-09-30-broadway_object %}
       <li>

         {{ 2005-09-30-broadway_object.comment }}

         <cite>{{ 2005-09-30-broadway_object.author }} on {{ 2005-09-30-broadway_object.date }}</cite>
