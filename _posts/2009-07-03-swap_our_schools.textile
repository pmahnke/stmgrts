...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2009-07-03-swap_our_schools in site.data.2009-07-03-swap_our_schools %}
       <li>

         {{ 2009-07-03-swap_our_schools.comment }}

         <cite>{{ 2009-07-03-swap_our_schools.author }} on {{ 2009-07-03-swap_our_schools.date }}</cite>
