...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-11-24-missing_cat_no_4_tama in site.data.2007-11-24-missing_cat_no_4_tama %}
       <li>

         {{ 2007-11-24-missing_cat_no_4_tama.comment }}

         <cite>{{ 2007-11-24-missing_cat_no_4_tama.author }} on {{ 2007-11-24-missing_cat_no_4_tama.date }}</cite>
