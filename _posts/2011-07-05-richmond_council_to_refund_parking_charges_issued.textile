...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2011-07-05-richmond_council_to_refund_parking_charges_issued in site.data.2011-07-05-richmond_council_to_refund_parking_charges_issued %}
       <li>

         {{ 2011-07-05-richmond_council_to_refund_parking_charges_issued.comment }}

         <cite>{{ 2011-07-05-richmond_council_to_refund_parking_charges_issued.author }} on {{ 2011-07-05-richmond_council_to_refund_parking_charges_issued.date }}</cite>
