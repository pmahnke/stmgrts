...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-10-05-fancy_a_good_si in site.data.2006-10-05-fancy_a_good_si %}
       <li>

         {{ 2006-10-05-fancy_a_good_si.comment }}

         <cite>{{ 2006-10-05-fancy_a_good_si.author }} on {{ 2006-10-05-fancy_a_good_si.date }}</cite>
