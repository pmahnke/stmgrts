...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-10-18-parcel_delivery in site.data.2006-10-18-parcel_delivery %}
       <li>

         {{ 2006-10-18-parcel_delivery.comment }}

         <cite>{{ 2006-10-18-parcel_delivery.author }} on {{ 2006-10-18-parcel_delivery.date }}</cite>
