...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2012-05-10-planning_lidl_supermarket_and_travelodge_in_east_t in site.data.2012-05-10-planning_lidl_supermarket_and_travelodge_in_east_t %}
       <li>

         {{ 2012-05-10-planning_lidl_supermarket_and_travelodge_in_east_t.comment }}

         <cite>{{ 2012-05-10-planning_lidl_supermarket_and_travelodge_in_east_t.author }} on {{ 2012-05-10-planning_lidl_supermarket_and_travelodge_in_east_t.date }}</cite>
