...
<img alt="snowflake" src="http://www.stmgrts.org.uk/archives/snowflake-thumb.jpg" width="161" height="156"  class="right"/>
...
Stalls are still available for residents and charities as well.  If you are interested, contact Kim Hare at "Nigel Hare joinery":/cgi-bin/directory.cgi?key=200506291050&action=getlisting.  The prices are _free_ for charities, {-L}10 for residents and {-L}20 for businesses.
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2005-11-24-st_margarets_ch in site.data.2005-11-24-st_margarets_ch %}
       <li>

         {{ 2005-11-24-st_margarets_ch.comment }}

         <cite>{{ 2005-11-24-st_margarets_ch.author }} on {{ 2005-11-24-st_margarets_ch.date }}</cite>
