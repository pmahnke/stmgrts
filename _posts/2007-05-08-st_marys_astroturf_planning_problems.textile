...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-05-08-st_marys_astroturf_planning_problems in site.data.2007-05-08-st_marys_astroturf_planning_problems %}
       <li>

         {{ 2007-05-08-st_marys_astroturf_planning_problems.comment }}

         <cite>{{ 2007-05-08-st_marys_astroturf_planning_problems.author }} on {{ 2007-05-08-st_marys_astroturf_planning_problems.date }}</cite>
