...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2010-01-21-event_reminder_say_hello in site.data.2010-01-21-event_reminder_say_hello %}
       <li>

         {{ 2010-01-21-event_reminder_say_hello.comment }}

         <cite>{{ 2010-01-21-event_reminder_say_hello.author }} on {{ 2010-01-21-event_reminder_say_hello.date }}</cite>
