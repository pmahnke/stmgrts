...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-09-18-local_writer_works_for_peace_in_palestine in site.data.2007-09-18-local_writer_works_for_peace_in_palestine %}
       <li>

         {{ 2007-09-18-local_writer_works_for_peace_in_palestine.comment }}

         <cite>{{ 2007-09-18-local_writer_works_for_peace_in_palestine.author }} on {{ 2007-09-18-local_writer_works_for_peace_in_palestine.date }}</cite>
