...
<img alt="ParVinu Logo" src="http://www.stmgrts.org.uk/archives/ParVinu-logo-thumb.gif" width="150" height="69" class="photo right" />
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-03-03-wine_bar_gets_t in site.data.2006-03-03-wine_bar_gets_t %}
       <li>

         {{ 2006-03-03-wine_bar_gets_t.comment }}

         <cite>{{ 2006-03-03-wine_bar_gets_t.author }} on {{ 2006-03-03-wine_bar_gets_t.date }}</cite>
