...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2012-04-30-pub_and_shop_news in site.data.2012-04-30-pub_and_shop_news %}
       <li>

         {{ 2012-04-30-pub_and_shop_news.comment }}

         <cite>{{ 2012-04-30-pub_and_shop_news.author }} on {{ 2012-04-30-pub_and_shop_news.date }}</cite>
