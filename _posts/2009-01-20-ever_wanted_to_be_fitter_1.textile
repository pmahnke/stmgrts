...
excerpt: |
    <a href="http://www.stmgrts.org.uk/images/ahm_fitter.jpg"><img src="http://www.stmgrts.org.uk/images/ahm_fitter-thumb.jpg" width="150" height="46" alt="Ever Wanted to be Fitter?" class="photo right"/></a>
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2009-01-20-ever_wanted_to_be_fitter_1 in site.data.2009-01-20-ever_wanted_to_be_fitter_1 %}
       <li>

         {{ 2009-01-20-ever_wanted_to_be_fitter_1.comment }}

         <cite>{{ 2009-01-20-ever_wanted_to_be_fitter_1.author }} on {{ 2009-01-20-ever_wanted_to_be_fitter_1.date }}</cite>
