...
excerpt: |
    <a href="http://www.stmgrts.org.uk/images//visits_2005-2010.png" title="See larger version of - visits to the site"><img src="http://www.stmgrts.org.uk/images//visits_2005-2010_thumb.png" width="150" height="96" alt="visits to the site" class=" right" /></a>
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2011-02-10-our_second_ever_reader_poll in site.data.2011-02-10-our_second_ever_reader_poll %}
       <li>

         {{ 2011-02-10-our_second_ever_reader_poll.comment }}

         <cite>{{ 2011-02-10-our_second_ever_reader_poll.author }} on {{ 2011-02-10-our_second_ever_reader_poll.date }}</cite>
