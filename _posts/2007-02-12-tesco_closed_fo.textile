...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-02-12-tesco_closed_fo in site.data.2007-02-12-tesco_closed_fo %}
       <li>

         {{ 2007-02-12-tesco_closed_fo.comment }}

         <cite>{{ 2007-02-12-tesco_closed_fo.author }} on {{ 2007-02-12-tesco_closed_fo.date }}</cite>
