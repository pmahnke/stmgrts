...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2005-11-05-council_fires_i in site.data.2005-11-05-council_fires_i %}
       <li>

         {{ 2005-11-05-council_fires_i.comment }}

         <cite>{{ 2005-11-05-council_fires_i.author }} on {{ 2005-11-05-council_fires_i.date }}</cite>
