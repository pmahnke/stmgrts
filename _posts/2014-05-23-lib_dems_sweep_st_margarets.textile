...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2014-05-23-lib_dems_sweep_st_margarets in site.data.2014-05-23-lib_dems_sweep_st_margarets %}
       <li>

         {{ 2014-05-23-lib_dems_sweep_st_margarets.comment }}

         <cite>{{ 2014-05-23-lib_dems_sweep_st_margarets.author }} on {{ 2014-05-23-lib_dems_sweep_st_margarets.date }}</cite>
