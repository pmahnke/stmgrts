...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-07-24-richmond_council_flood_update in site.data.2007-07-24-richmond_council_flood_update %}
       <li>

         {{ 2007-07-24-richmond_council_flood_update.comment }}

         <cite>{{ 2007-07-24-richmond_council_flood_update.author }} on {{ 2007-07-24-richmond_council_flood_update.date }}</cite>
