...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-03-16-notes_from_moor in site.data.2006-03-16-notes_from_moor %}
       <li>

         {{ 2006-03-16-notes_from_moor.comment }}

         <cite>{{ 2006-03-16-notes_from_moor.author }} on {{ 2006-03-16-notes_from_moor.date }}</cite>
