...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2011-04-14-planning_twickenham_railway_station in site.data.2011-04-14-planning_twickenham_railway_station %}
       <li>

         {{ 2011-04-14-planning_twickenham_railway_station.comment }}

         <cite>{{ 2011-04-14-planning_twickenham_railway_station.author }} on {{ 2011-04-14-planning_twickenham_railway_station.date }}</cite>
