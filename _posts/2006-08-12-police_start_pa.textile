...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-08-12-police_start_pa in site.data.2006-08-12-police_start_pa %}
       <li>

         {{ 2006-08-12-police_start_pa.comment }}

         <cite>{{ 2006-08-12-police_start_pa.author }} on {{ 2006-08-12-police_start_pa.date }}</cite>
