...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2005-06-30-richmond_upon_t in site.data.2005-06-30-richmond_upon_t %}
       <li>

         {{ 2005-06-30-richmond_upon_t.comment }}

         <cite>{{ 2005-06-30-richmond_upon_t.author }} on {{ 2005-06-30-richmond_upon_t.date }}</cite>
