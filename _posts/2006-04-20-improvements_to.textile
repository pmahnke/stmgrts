...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-04-20-improvements_to in site.data.2006-04-20-improvements_to %}
       <li>

         {{ 2006-04-20-improvements_to.comment }}

         <cite>{{ 2006-04-20-improvements_to.author }} on {{ 2006-04-20-improvements_to.date }}</cite>
