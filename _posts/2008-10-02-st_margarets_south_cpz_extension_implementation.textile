...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2008-10-02-st_margarets_south_cpz_extension_implementation in site.data.2008-10-02-st_margarets_south_cpz_extension_implementation %}
       <li>

         {{ 2008-10-02-st_margarets_south_cpz_extension_implementation.comment }}

         <cite>{{ 2008-10-02-st_margarets_south_cpz_extension_implementation.author }} on {{ 2008-10-02-st_margarets_south_cpz_extension_implementation.date }}</cite>
