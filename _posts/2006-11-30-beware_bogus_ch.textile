...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-11-30-beware_bogus_ch in site.data.2006-11-30-beware_bogus_ch %}
       <li>

         {{ 2006-11-30-beware_bogus_ch.comment }}

         <cite>{{ 2006-11-30-beware_bogus_ch.author }} on {{ 2006-11-30-beware_bogus_ch.date }}</cite>
