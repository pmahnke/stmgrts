...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2012-02-10-linked_primary_schools_to_be_scrapped_for_orleans in site.data.2012-02-10-linked_primary_schools_to_be_scrapped_for_orleans %}
       <li>

         {{ 2012-02-10-linked_primary_schools_to_be_scrapped_for_orleans.comment }}

         <cite>{{ 2012-02-10-linked_primary_schools_to_be_scrapped_for_orleans.author }} on {{ 2012-02-10-linked_primary_schools_to_be_scrapped_for_orleans.date }}</cite>
