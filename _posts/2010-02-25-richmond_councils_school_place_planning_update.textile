...
The Richmond Council will send "this leaflet to all parents of school age parents tomorrow [PDF]":http://www.stmgrts.org.uk/StMgts_CETwick_primary_places.pdf outlining the current state of the issues around school places and the two options they are currently considering.
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2010-02-25-richmond_councils_school_place_planning_update in site.data.2010-02-25-richmond_councils_school_place_planning_update %}
       <li>

         {{ 2010-02-25-richmond_councils_school_place_planning_update.comment }}

         <cite>{{ 2010-02-25-richmond_councils_school_place_planning_update.author }} on {{ 2010-02-25-richmond_councils_school_place_planning_update.date }}</cite>
