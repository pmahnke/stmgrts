...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2005-12-14-interview_kerri in site.data.2005-12-14-interview_kerri %}
       <li>

         {{ 2005-12-14-interview_kerri.comment }}

         <cite>{{ 2005-12-14-interview_kerri.author }} on {{ 2005-12-14-interview_kerri.date }}</cite>
