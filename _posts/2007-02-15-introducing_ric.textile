...
<img src="http://www.mailspaces.com/spaces/nigelsblog/knowledge/entries/banners/FreeSharing.gif" width="360" height="58" class="photo center" alt="FreeSharing Logo" />
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-02-15-introducing_ric in site.data.2007-02-15-introducing_ric %}
       <li>

         {{ 2007-02-15-introducing_ric.comment }}

         <cite>{{ 2007-02-15-introducing_ric.author }} on {{ 2007-02-15-introducing_ric.date }}</cite>
