...
---
 ...
 <img src="http://www.stmgrts.org.uk/images/directory/200911130711_Mrs_Moon.jpg"  alt="Mrs_Moon" class="photo center" />
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2009-11-13-st_margarets_traders_association_welcome_mrs_moon in site.data.2009-11-13-st_margarets_traders_association_welcome_mrs_moon %}
       <li>

         {{ 2009-11-13-st_margarets_traders_association_welcome_mrs_moon.comment }}

         <cite>{{ 2009-11-13-st_margarets_traders_association_welcome_mrs_moon.author }} on {{ 2009-11-13-st_margarets_traders_association_welcome_mrs_moon.date }}</cite>
