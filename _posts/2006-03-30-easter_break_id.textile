...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-03-30-easter_break_id in site.data.2006-03-30-easter_break_id %}
       <li>

         {{ 2006-03-30-easter_break_id.comment }}

         <cite>{{ 2006-03-30-easter_break_id.author }} on {{ 2006-03-30-easter_break_id.date }}</cite>
