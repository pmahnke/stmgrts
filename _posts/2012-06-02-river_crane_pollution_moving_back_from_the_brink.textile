...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2012-06-02-river_crane_pollution_moving_back_from_the_brink in site.data.2012-06-02-river_crane_pollution_moving_back_from_the_brink %}
       <li>

         {{ 2012-06-02-river_crane_pollution_moving_back_from_the_brink.comment }}

         <cite>{{ 2012-06-02-river_crane_pollution_moving_back_from_the_brink.author }} on {{ 2012-06-02-river_crane_pollution_moving_back_from_the_brink.date }}</cite>
