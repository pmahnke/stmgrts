...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-10-08-par_vinu_wine_b in site.data.2006-10-08-par_vinu_wine_b %}
       <li>

         {{ 2006-10-08-par_vinu_wine_b.comment }}

         <cite>{{ 2006-10-08-par_vinu_wine_b.author }} on {{ 2006-10-08-par_vinu_wine_b.date }}</cite>
