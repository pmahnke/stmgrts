...
excerpt: |
    <img alt="aeroplane noise" src="http://www.stmgrts.org.uk/images/airportnoise-thumb.jpg" width="111" height="106" class="right" />
...
-- _from a HACAN Press Release_


<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-06-01-baa_launches_webtrak in site.data.2007-06-01-baa_launches_webtrak %}
       <li>

         {{ 2007-06-01-baa_launches_webtrak.comment }}

         <cite>{{ 2007-06-01-baa_launches_webtrak.author }} on {{ 2007-06-01-baa_launches_webtrak.date }}</cite>
