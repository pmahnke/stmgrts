...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-07-04-comment_spam in site.data.2006-07-04-comment_spam %}
       <li>

         {{ 2006-07-04-comment_spam.comment }}

         <cite>{{ 2006-07-04-comment_spam.author }} on {{ 2006-07-04-comment_spam.date }}</cite>
