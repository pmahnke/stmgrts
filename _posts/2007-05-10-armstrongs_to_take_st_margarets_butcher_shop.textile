...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-05-10-armstrongs_to_take_st_margarets_butcher_shop in site.data.2007-05-10-armstrongs_to_take_st_margarets_butcher_shop %}
       <li>

         {{ 2007-05-10-armstrongs_to_take_st_margarets_butcher_shop.comment }}

         <cite>{{ 2007-05-10-armstrongs_to_take_st_margarets_butcher_shop.author }} on {{ 2007-05-10-armstrongs_to_take_st_margarets_butcher_shop.date }}</cite>
