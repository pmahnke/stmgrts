...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-10-12-local_group_mag in site.data.2006-10-12-local_group_mag %}
       <li>

         {{ 2006-10-12-local_group_mag.comment }}

         <cite>{{ 2006-10-12-local_group_mag.author }} on {{ 2006-10-12-local_group_mag.date }}</cite>
