...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-09-20-crown_road_fair_update in site.data.2007-09-20-crown_road_fair_update %}
       <li>

         {{ 2007-09-20-crown_road_fair_update.comment }}

         <cite>{{ 2007-09-20-crown_road_fair_update.author }} on {{ 2007-09-20-crown_road_fair_update.date }}</cite>
