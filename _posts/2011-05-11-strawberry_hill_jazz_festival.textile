...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2011-05-11-strawberry_hill_jazz_festival in site.data.2011-05-11-strawberry_hill_jazz_festival %}
       <li>

         {{ 2011-05-11-strawberry_hill_jazz_festival.comment }}

         <cite>{{ 2011-05-11-strawberry_hill_jazz_festival.author }} on {{ 2011-05-11-strawberry_hill_jazz_festival.date }}</cite>
