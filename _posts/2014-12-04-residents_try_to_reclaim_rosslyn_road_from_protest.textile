...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2014-12-04-residents_try_to_reclaim_rosslyn_road_from_protest in site.data.2014-12-04-residents_try_to_reclaim_rosslyn_road_from_protest %}
       <li>

         {{ 2014-12-04-residents_try_to_reclaim_rosslyn_road_from_protest.comment }}

         <cite>{{ 2014-12-04-residents_try_to_reclaim_rosslyn_road_from_protest.author }} on {{ 2014-12-04-residents_try_to_reclaim_rosslyn_road_from_protest.date }}</cite>
