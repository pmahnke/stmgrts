...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2014-01-08-petition_step_free_access_at_st_margarets_station in site.data.2014-01-08-petition_step_free_access_at_st_margarets_station %}
       <li>

         {{ 2014-01-08-petition_step_free_access_at_st_margarets_station.comment }}

         <cite>{{ 2014-01-08-petition_step_free_access_at_st_margarets_station.author }} on {{ 2014-01-08-petition_step_free_access_at_st_margarets_station.date }}</cite>
