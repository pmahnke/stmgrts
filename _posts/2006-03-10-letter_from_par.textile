...
_After their recent "conditional planning approval":/archives/2006/03/wine_bar_gets_t.html we asked the principles of the wine bar if they wanted to comment.  This was the letter we received and they were happy for us to publish it._
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-03-10-letter_from_par in site.data.2006-03-10-letter_from_par %}
       <li>

         {{ 2006-03-10-letter_from_par.comment }}

         <cite>{{ 2006-03-10-letter_from_par.author }} on {{ 2006-03-10-letter_from_par.date }}</cite>
