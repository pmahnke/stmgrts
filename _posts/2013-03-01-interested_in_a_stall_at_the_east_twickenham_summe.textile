...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2013-03-01-interested_in_a_stall_at_the_east_twickenham_summe in site.data.2013-03-01-interested_in_a_stall_at_the_east_twickenham_summe %}
       <li>

         {{ 2013-03-01-interested_in_a_stall_at_the_east_twickenham_summe.comment }}

         <cite>{{ 2013-03-01-interested_in_a_stall_at_the_east_twickenham_summe.author }} on {{ 2013-03-01-interested_in_a_stall_at_the_east_twickenham_summe.date }}</cite>
