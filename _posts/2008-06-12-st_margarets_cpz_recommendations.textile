...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2008-06-12-st_margarets_cpz_recommendations in site.data.2008-06-12-st_margarets_cpz_recommendations %}
       <li>

         {{ 2008-06-12-st_margarets_cpz_recommendations.comment }}

         <cite>{{ 2008-06-12-st_margarets_cpz_recommendations.author }} on {{ 2008-06-12-st_margarets_cpz_recommendations.date }}</cite>
