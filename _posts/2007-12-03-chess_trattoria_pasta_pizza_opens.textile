...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-12-03-chess_trattoria_pasta_pizza_opens in site.data.2007-12-03-chess_trattoria_pasta_pizza_opens %}
       <li>

         {{ 2007-12-03-chess_trattoria_pasta_pizza_opens.comment }}

         <cite>{{ 2007-12-03-chess_trattoria_pasta_pizza_opens.author }} on {{ 2007-12-03-chess_trattoria_pasta_pizza_opens.date }}</cite>
