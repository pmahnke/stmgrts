...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-02-25-hawk_in_moormea in site.data.2007-02-25-hawk_in_moormea %}
       <li>

         {{ 2007-02-25-hawk_in_moormea.comment }}

         <cite>{{ 2007-02-25-hawk_in_moormea.author }} on {{ 2007-02-25-hawk_in_moormea.date }}</cite>
