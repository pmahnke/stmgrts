...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2009-09-25-66_crown_road_update in site.data.2009-09-25-66_crown_road_update %}
       <li>

         {{ 2009-09-25-66_crown_road_update.comment }}

         <cite>{{ 2009-09-25-66_crown_road_update.author }} on {{ 2009-09-25-66_crown_road_update.date }}</cite>
