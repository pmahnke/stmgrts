...
h4. Supporting documentation and consultation with residents.
...
h4. The number of HMOs in the borough.
...
h4.  Local residents may also wish to refer their concerns to the only ward councillor who is not part of the Planning Committee
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2009-07-03-planning_update_hostel_planned_for_former_crown_ro in site.data.2009-07-03-planning_update_hostel_planned_for_former_crown_ro %}
       <li>

         {{ 2009-07-03-planning_update_hostel_planned_for_former_crown_ro.comment }}

         <cite>{{ 2009-07-03-planning_update_hostel_planned_for_former_crown_ro.author }} on {{ 2009-07-03-planning_update_hostel_planned_for_former_crown_ro.date }}</cite>
