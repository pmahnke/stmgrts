...
excerpt: |
    <a href="http://www.stmgrts.org.uk/images/martins_parking_poster.gif"><img alt="martins_parking_poster.gif" src="http://www.stmgrts.org.uk/images/martins_parking_poster-thumb.gif" width="133" height="150" class="photo right"/></a>
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-06-06-martin_herdman_speaks_out_on_parking_isuses_for_tr in site.data.2007-06-06-martin_herdman_speaks_out_on_parking_isuses_for_tr %}
       <li>

         {{ 2007-06-06-martin_herdman_speaks_out_on_parking_isuses_for_tr.comment }}

         <cite>{{ 2007-06-06-martin_herdman_speaks_out_on_parking_isuses_for_tr.author }} on {{ 2007-06-06-martin_herdman_speaks_out_on_parking_isuses_for_tr.date }}</cite>
