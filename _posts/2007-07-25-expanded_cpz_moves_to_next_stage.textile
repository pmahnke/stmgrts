...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-07-25-expanded_cpz_moves_to_next_stage in site.data.2007-07-25-expanded_cpz_moves_to_next_stage %}
       <li>

         {{ 2007-07-25-expanded_cpz_moves_to_next_stage.comment }}

         <cite>{{ 2007-07-25-expanded_cpz_moves_to_next_stage.author }} on {{ 2007-07-25-expanded_cpz_moves_to_next_stage.date }}</cite>
