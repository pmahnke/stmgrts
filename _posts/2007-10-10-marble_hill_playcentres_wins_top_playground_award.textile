...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-10-10-marble_hill_playcentres_wins_top_playground_award in site.data.2007-10-10-marble_hill_playcentres_wins_top_playground_award %}
       <li>

         {{ 2007-10-10-marble_hill_playcentres_wins_top_playground_award.comment }}

         <cite>{{ 2007-10-10-marble_hill_playcentres_wins_top_playground_award.author }} on {{ 2007-10-10-marble_hill_playcentres_wins_top_playground_award.date }}</cite>
