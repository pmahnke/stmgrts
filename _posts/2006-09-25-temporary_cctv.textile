...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-09-25-temporary_cctv in site.data.2006-09-25-temporary_cctv %}
       <li>

         {{ 2006-09-25-temporary_cctv.comment }}

         <cite>{{ 2006-09-25-temporary_cctv.author }} on {{ 2006-09-25-temporary_cctv.date }}</cite>
