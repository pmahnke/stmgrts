...
h3. The Teeth Have It

_sent 12 November 2004_
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2005-11-14-letters_to_amer_1 in site.data.2005-11-14-letters_to_amer_1 %}
       <li>

         {{ 2005-11-14-letters_to_amer_1.comment }}

         <cite>{{ 2005-11-14-letters_to_amer_1.author }} on {{ 2005-11-14-letters_to_amer_1.date }}</cite>
