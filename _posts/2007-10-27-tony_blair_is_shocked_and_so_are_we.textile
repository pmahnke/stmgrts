...
<div class="box"><em>This is the third dispatch from Gill Swain, a local writer who has <a href="http://www.stmgrts.org.uk/archives/2007/09/local_writer_works_for_peace_in_palestine.html">traveled to Palestine</a> to work for peace with the World Council of Churches </em>.</div>
...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2007-10-27-tony_blair_is_shocked_and_so_are_we in site.data.2007-10-27-tony_blair_is_shocked_and_so_are_we %}
       <li>

         {{ 2007-10-27-tony_blair_is_shocked_and_so_are_we.comment }}

         <cite>{{ 2007-10-27-tony_blair_is_shocked_and_so_are_we.author }} on {{ 2007-10-27-tony_blair_is_shocked_and_so_are_we.date }}</cite>
