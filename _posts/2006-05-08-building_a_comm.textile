...
<div class="comments">
  <h2>Comments</h2>
     <ul>
{% for 2006-05-08-building_a_comm in site.data.2006-05-08-building_a_comm %}
       <li>

         {{ 2006-05-08-building_a_comm.comment }}

         <cite>{{ 2006-05-08-building_a_comm.author }} on {{ 2006-05-08-building_a_comm.date }}</cite>
